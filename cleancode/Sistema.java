...
public class Sistema {
    ...
    public void novoPedido() {
        ...
        for (int i = 0; i < p.itens.size(); i++) {
            total = total + (p.itens.get(i).preco * p.itens.get(i).quantidade);
        }
    ...
    public void buscar() {
        ...
        for (int i = 0; i < pedidos.size(); i++) {
            ...
            if (p.id == id) {
                ...
                double subtotal = 0;
                for (int j = 0; j < p.itens.size(); j++) {
                    subtotal = subtotal + (p.itens.get(j).preco * p.itens.get(j).quantidade);
                }
                ...
                for (int j = 0; j < p.itens.size(); j++) {
                    Item it = p.itens.get(j);
                    System.out.println("item " + (j + 1) + ": " + it.nome + " / " + it.quantidade + " / " + it.preco);
                }
            }
        }
